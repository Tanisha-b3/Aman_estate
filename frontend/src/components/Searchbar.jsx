...
export default function SearchBar() {
  return (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex flex-col md:flex-row items-center justify-center bg-white p-6 rounded-xl shadow-xl max-w-6xl w-[90%] space-y-4 md:space-y-0 md:space-x-4">
